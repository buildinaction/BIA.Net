namespace ZZCompanyNameZZ.ZZProjectNameZZ.Test.Helpers
{
    ...
    {
        //Main Container
        private Mock<ZZProjectNameZZDBContainer> mockContext;
        ...
        public MockEntityFrameWork()
        {
            ...
            this.mockContext = EntityFrameworkMoqHelper.CreateMockForDbContext<ZZProjectNameZZDBContainer, Site>(this.mockSiteSet);
            ...
            TDBContainer<ZZProjectNameZZDBContainer>.SetMoqContext(this.mockContext.Object);
        }
