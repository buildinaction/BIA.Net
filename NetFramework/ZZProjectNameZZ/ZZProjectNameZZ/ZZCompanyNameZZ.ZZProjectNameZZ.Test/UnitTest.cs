namespace ZZCompanyNameZZ.ZZProjectNameZZ.Test
{
    ...
    public class UnitTest
    {
        ...
        public void MemberRole_CRUD_operations_basics()
        {
            ...
            var mockContext = new Mock<ZZProjectNameZZDBContainer>();
            mockContext.Setup(c => c.Set<MemberRole>()).Returns(mockMemberRoleSet.Object);
            TDBContainer<ZZProjectNameZZDBContainer>.SetMoqContext(mockContext.Object);
            mockMemberRoleSet.Setup(x => x.AsNoTracking()).Returns(mockMemberRoleSet.Object);
        ...
        public void Site_CRUD_Check_Right_UserCannotUpadate()
        {
            ...
            int SiteReadId = 2;
            Mock<ZZProjectNameZZDBContainer> mockContext = PrepareMockForRigthTest(connectedUser);
        ...
        public void Site_CRUD_Check_Right_AdminCanUpadate()
        {
            ...
            //Add a member:
            Assert.AreEqual(siteDTO.Members.Count, 1);
            siteDTO.Members.Add(new MemberDTO() { User = new UserDTO() { Id = connectedUser.Id } });
            siteDTO = AllServicesDTO.UpdateValues(siteDTO, new List<string>() { nameof(SiteDTO.Members) });
            Assert.IsNotNull(siteDTO);
            Assert.AreEqual(siteDTO.Members.Count, 2);
            siteDTO = AllServicesDTO.Find<SiteDTO>(SiteReadId);
            Assert.AreEqual(siteDTO.Members.Count, 2);
        ...
        private static Mock<ZZProjectNameZZDBContainer> PrepareMockForRigthTest(User connectedUser)
        {
            ...
            var mockSiteSet = EntityFrameworkMoqHelper.CreateMockForDbSet<Site>()
                                                            ...
                                                            .WithFind(sites, "Id")
                                                            .WithRemove(sites);
            return EntityFrameworkMoqHelper.CreateMockForDbContext<ZZProjectNameZZDBContainer, Site>(mockSiteSet);
        }
    }
}
