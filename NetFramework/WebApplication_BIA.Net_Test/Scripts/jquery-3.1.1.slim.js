...
setDocument = Sizzle.setDocument = function( node ) {
	...
	if ( (support.qsa = rnative.test( document.querySelectorAll )) ) {
		...
		assert(function( el ) {
			...
			// https://bugs.webkit.org/show_bug.BIA?id=136851
...
function getWidthOrHeight( elem, name, extra ) {
	...
	// svg - https://bugzilla.mozilla.org/show_bug.BIA?id=649285
	// MathML - https://bugzilla.mozilla.org/show_bug.BIA?id=491668
	if ( val <= 0 || val == null ) {
...
// Related ticket - https://bugzilla.mozilla.org/show_bug.BIA?id=687787
//
...
// https://bugs.webkit.org/show_bug.BIA?id=137337
...
// Webkit bug: https://bugs.webkit.org/show_bug.BIA?id=29084
