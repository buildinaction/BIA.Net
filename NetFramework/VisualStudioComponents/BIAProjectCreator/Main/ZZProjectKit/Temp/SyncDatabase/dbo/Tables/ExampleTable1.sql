CREATE TABLE [dbo].[ExampleTable1] (
    ...
    CONSTRAINT [FK_SiteExampleTable1] FOREIGN KEY ([Site_Id]) REFERENCES [dbo].[Site] ([Id])
);
...
GO
CREATE NONCLUSTERED INDEX [IX_FK_SiteExampleTable1]
    ON [dbo].[ExampleTable1]([Site_Id] ASC);
