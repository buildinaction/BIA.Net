    ...
    public static class MapperService
    {
        ...
        public static void InitMapping()
        {
            Dictionary<Type, TypeMapper> serviceMappings = new Dictionary<Type, TypeMapper>
            {
                ...
                // { typeof(ExampleTable1DTO), new TypeMapper(typeof(TServiceDTO<ExampleTable1DTO, ExampleTable1, $saferootprojectname$DBContainer>), typeof(ExampleTable1Mapper)) },
                // { typeof(ExampleTable2DTO), new TypeMapper(typeof(TServiceDTO<ExampleTable2DTO, ExampleTable2, $saferootprojectname$DBContainer>), typeof(ExampleTable2Mapper)) },
