namespace $safeprojectname$.Controllers
{
    ...
    public class SitesController : ApiController
    {
        ...
        // PUT: api/Sites/5
        [HttpPut]
        [Route("api/Sites/WithMembers")]
        public IHttpActionResult UpdateWithMembers(int id, [FromBody]SiteDTO value)
        {
            if (id > 0 && value != null)
            {
                SiteDTO obj = this.serviceSite.UpdateWithMembers(value);
        ...
        public IHttpActionResult Delete(int id)
        {
            if (id > 0)
            {
                int ret = this.serviceSite.DeleteByIdWithMembers(id);
