...
namespace Safran.BIADemo.Crosscutting.Ioc
{
    ...
    // Begin BIADemo
    using Safran.BIADemo.Application.Plane;

    // End BIADemo
    using Safran.BIADemo.Application.Site;
    using Safran.BIADemo.Application.User;
    using Safran.BIADemo.Application.View;
    using Safran.BIADemo.Domain.RepoContract;
    using Safran.BIADemo.Domain.UserModule.Aggregate;
    using Safran.BIADemo.Domain.UserModule.Service;
    using Safran.BIADemo.Infrastructure.Data;
    using Safran.BIADemo.Infrastructure.Data.Repositories.QueryCustomizer;
    using Safran.BIADemo.Infrastructure.Service.Repositories;
