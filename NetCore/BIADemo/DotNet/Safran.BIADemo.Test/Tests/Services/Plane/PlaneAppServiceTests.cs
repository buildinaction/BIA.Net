// BIADemo only
// <copyright file="PlaneAppServiceTests.cs" company="Safran">
//     Copyright (c) Safran. All rights reserved.
// </copyright>
namespace Safran.BIADemo.Test.Tests.Services.Plane
{
    using System;
    ...
    public class PlaneAppServiceTests : AbstractUnitTest
    {
        ...
        {
            (IEnumerable<PlaneListItemDto> results, int total) = this.service.GetRangeAsync(null).Result;
            Assert.AreEqual(2, total);
            List<PlaneListItemDto> planes = results.ToList();
