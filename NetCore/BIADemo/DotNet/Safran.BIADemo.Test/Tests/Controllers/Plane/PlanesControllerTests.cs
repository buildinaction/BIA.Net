// BIADemo only
// <copyright file="PlanesControllerTests.cs" company="Safran">
//     Copyright (c) Safran. All rights reserved.
// </copyright>
namespace Safran.BIADemo.Test.Tests.Controllers.Plane
{
    ...
    public class PlanesControllerTests : AbstractUnitTest
    {
        ...
        public void GetAllTest()
        {
            ...
            IEnumerable<PlaneListItemDto> planes = result.Value as IEnumerable<PlaneListItemDto>;
