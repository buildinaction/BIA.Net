// <copyright file="UserAppService.cs" company="Safran">
...
namespace Safran.BIADemo.Application.User
{
    ...
    public class UserAppService : AppServiceBase<User>, IUserAppService
    {
        ...
        /// <inheritdoc cref="IUserAppService.GetAllAsync(Safran.BIADemo.Domain.Dto.Bia.LazyLoadDto)"/>
        ...
        {
            return await this.userRightDomainService.GetRightsForUserAsync(userDirectoryRoles, sid, siteId);
        }
